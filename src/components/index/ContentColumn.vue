<template>
  <div class="content-column">
    <div class="first-line">
      ...
      <span class="v-3d" v-show="item.version==='v3d imax'"></span>
      <span class="v-2d" v-show="item.version==='v2d imax'"></span>
      <span class="only-3d" v-show="item.version==='v3d'"></span>
    </div>
    <div class="score-line" v-show="hasscore">
      <span class="score-title">观众评 </span>
      <span class="score-num">{{ item.sc }}</span>
    </div>
    <div class="want-to-see" v-show="!hasscore">
      <span class="person">{{ item.wish }}</span>
      <span class="wish">人想看</span>
    </div>
    <div class="actor">
      {{ item.star }}
    </div>
